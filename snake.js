...
const snake = {
    ...
    getScore() {
        ...
        const score = this.body.length - 1;
        scoreCounter.textContent = 'Счёт игры: ' + score;
    },
...
const game = {
    ...
    reset() {
        ...
        this.wall.setWallCoordinates(this.getRandomFreeCoordinates());
        this.render();
    },
    ...
    getRandomFreeCoordinates() {
        const exclude = [this.wall.getWallCoordinates(), this.food.getCoordinates(), this.snake.getBody()];
        // without ... -  [{}, [{}, {}, {}]] => with ... [{}, {}, {}, {}];
        while (true) {
            const rndPoint = {
    ...
    render() {
        this.map.render(this.snake.getBody(), this.food.getCoordinates(), this.wall.getWallCoordinates());
    },
    ...
    tickHandler() {
        if (!this.canMakeStep() || this.snake.isOnPoint(this.wall)) return this.finish();
